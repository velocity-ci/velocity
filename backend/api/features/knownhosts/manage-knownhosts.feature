...
I need to be able to manage trusted hosts
  ...
  Scenario: List trusted hosts
    ...
    And the response has the following attributes:
      | attribute          | type    | value                                              |
      | total              | integer | 1                                                  |
      | result[0].id       | string  | *any                                               |
      | result[0].hosts[0] | string  | github.com                                         |
      | result[0].comment  | string  |                                                    |
      | result[0].sha256   | string  | SHA256:nThbg6kXUpJWGl7E1IGOCspRomTxdCARLviKw6E5SY8 |
      | result[0].md5      | string  | 16:27:ac:a5:76:28:2d:36:63:1b:56:4d:eb:df:a6:48    |