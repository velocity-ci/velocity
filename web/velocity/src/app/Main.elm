                ...
                in
                    case model.session.user of
                        Just user ->
                            ...
                            , Cmd.batch [ pageCmd, Cmd.map SocketMsg socketCmd ]
                            )
...
setRouteUpdate maybeRoute model =
    ...
    in
        ( routeModel
        , Cmd.batch [ routeCmd, channelLeaveCmd, Ports.scrollTo ( 0, 0 ) ]
        )
        ...
        case ( msg, page ) of
            ...
            ( HomeMsg subMsg, Home subModel ) ->
                ...
                in
                    ...
                    , Cmd.batch [ Cmd.map HomeMsg newSubCmd, cmdAfterExternalMsg ]
                    )
            ...
            ( KnownHostsMsg subMsg, KnownHosts subModel ) ->
                ...
                in
                    ( modelAfterExternalMsg
                    , Cmd.batch [ Cmd.map KnownHostsMsg newSubCmd, cmdAfterExternalMsg ]
                    )
