defmodule ArchitectWeb.Schema.Middleware.TranslateMessages do
  ...
  defp translate_message(%Kronky.ValidationMessage{} = validation_message) do
    ...
    Map.update!(validation_message, :message, fn _message ->
      if count = opts[:count] do
        Gettext.dngettext(ArchitectWeb.Gettext, "errors", template, template, count, opts)
      else
        Gettext.dgettext(ArchitectWeb.Gettext, "errors", template, opts)
      end
    end)
  end
end
